...
void UItemConverterComponentEventListener::OnItemSetInInputSlot(APhysicalItem* Item) {
}

void UItemConverterComponentEventListener::OnItemReleasedFromOutputSlot(APhysicalItem* Item) {
}

void UItemConverterComponentEventListener::OnItemReleasedFromInputSlot(APhysicalItem* Item) {
}
