...
FStreamingPowerMergedNodeComponent UStreamingPowerMergedNodeComponentContainer::FindStreamingPowerMergedNodeComponent(FAstroDatumRef EntityRef, bool& bOutSuccess) {
    return FStreamingPowerMergedNodeComponent{};
}
