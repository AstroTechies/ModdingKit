...
#include "UObject/NoExportTypes.h"
#include "EItemRetrievalQuantityFilter.h"
...
public:
    ...
    UFUNCTION(BlueprintCallable)
    static bool SpawnItemsInSlotArray(const TArray<FSlotReference> &Slots, const TArray<TSubclassOf<UItemType>> &ItemsToSpawn, TArray<APhysicalItem *> &OutSpawnedItems);
    ...
    UFUNCTION(BlueprintCallable)
    static int32 AttemptToFetchItemsFromConnectedStorageSlotNetworkToSlotArray(TSubclassOf<UItemType> ItemToRetrieve, const TArray<FSlotReference> &Slots, AActor *ActorInStorageNetwork, int32 NumToTake);

    UFUNCTION(BlueprintCallable)
    static bool AttemptToFetchItemFromConnectedStorageSlotNetworkToSlotArray(TSubclassOf<UItemType> ItemToRetrieve, const TArray<FSlotReference> &Slots, AActor *ActorInStorageNetwork, EItemRetrievalQuantityFilter ItemRetrievalQuantityFilter, bool TakeAll);
