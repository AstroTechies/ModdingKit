...
#include "ModDeployerSaveGame.generated.h"

UCLASS()
class UModDeployerSaveGame : public USaveGame
{
	GENERATED_BODY()
...
public:
	...
	FString ModFolder = TEXT("Astro/Content/Mods/YourNameHere/TestMod");
	...
	FString PaksFolder = TEXT("%LOCALAPPDATA%\\Astro\\Saved\\Paks");
	...
	FString InstallationPaksFolder = TEXT("D:\\Games\\steamapps\\common\\ASTRONEER\\Astro\\Content\\Paks");
