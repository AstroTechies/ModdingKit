...
void FModDeployerCommands::RegisterCommands()
{
	...
	UI_COMMAND(PluginActionQuick, "Quick Deploy", "Quickly execute \"Run everything\" without needing the Mod Deployer tab open", EUserInterfaceActionType::Button, FInputChord());
}
